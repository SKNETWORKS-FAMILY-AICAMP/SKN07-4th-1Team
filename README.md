...
# 4차 프로젝트 - LLM을 연동한 내외부 문서 기반의 질의 응답 웹페이지 개발
...
세세한 요구사항에도 맞춤형 숙박업소를 추천을 해주는 챗봇입니다.
간편한 UI와 고성능의 LLM을 갖춘 웹애플리케이션을 구현했습니다.
...
이런 시스템을 담은 웹 애플리케이션은 이용자의 접근성을 높이고, 더 나은 사용자 경험을 제공할 수 있습니다. 
